...
Going through many of these steps will give you a valuable broad overview of your data. These analyses can give you insight into what methods you are able to use in your analysis. The genotype curve can tell you if you've sampled enough loci (or if you have over sampled) and `info_table` gives a nice visualization to aid assessing whether or not there is missing data in your sample. For clonal populations, the genotypic diversity table is valuable for informing you of how to clone-correct populations, which we will tackle in the [next chapter](C05_Population_Hierarchies.html). 
