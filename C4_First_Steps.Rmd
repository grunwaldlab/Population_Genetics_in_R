...
This concludes our first introduction on how to count genotypes and determine genotypic diversity, evenness and richness in populations. In the [next chapter](C5_Population_Hierarchies) we will learn how to subset and clone-correct populations. 
