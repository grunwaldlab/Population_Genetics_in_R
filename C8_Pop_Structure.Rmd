...
```
---
title: '8: Population structure: $G_{ST}$, clustering and minimum spanning networks'
---
...
see [Chapter 6](C6_Genotypic_EvenRichDiv.html) for more details. We will be
...
# Visualize
set.seed(9001)
plot_poppr_msn(popsub(t26, sub9), t26.9msn, inds = "none", palette = cm.colors)
```

We can see that the BB in the tree heavily contributed to the major groups of MLGs found in the FR. Now see if you can produce similar graphs with the 2010 and 2011 populations.
...
```
![MX_PCA](C8_Pop_Structure_files/figure-html/MXPCA.png)
...
![MX_CLUSTER](C8_Pop_Structure_files/figure-html/MXCLUST.png)
...
```
![SA_PCA](C8_Pop_Structure_files/figure-html/SAPCA.png)
...
![SA_CLUSTER](C8_Pop_Structure_files/figure-html/SACLUST.png)
...
Now we will build trees. We are using Bruvo's distance since polyploidies bias calculation of other distances: 
