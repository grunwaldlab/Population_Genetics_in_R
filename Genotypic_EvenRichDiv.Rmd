...
For the analysis, we need to read in the data, specify the stratifications in the data, and then set the hierarchical level to symptom so that we can calculate genotypic richness, diversity, and evenness for BB as compared to FR for the entire data set:
