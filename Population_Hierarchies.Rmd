...
When dealing wtih a clonal populations, analyses are typically conducted with
and without clone corrections. Clone correction results in retaining only one
individual per MLG. This technique is commonly used with the analysis of the
index of association. Clone correction requires specification of the
hierarchical levels at which clones should be censored.
...
> The harmonic mean takes the reciprocal of the arithmetic mean of the reciprocal.
...
to have analyzed in a single command line.  This approach avoids having to
