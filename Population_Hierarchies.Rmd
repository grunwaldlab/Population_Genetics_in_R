...
> The `splithierarchy` command only needs to be run once: right after you import
> your data. 
...
original data to the same hierarchy:
...
you are about to write a function. Arguments are varaibles that you will give
to the function and the curly braces (`{` and `}`) is the place where you write 
