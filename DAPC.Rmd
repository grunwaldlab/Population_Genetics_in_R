...
ensuring that you have selected the correct number of PC is to do cross-
validation. This is a procedure in which you leave out a certain percentage of
...
conclusion was from DAPC results. Here, we will recreate the process of cross
