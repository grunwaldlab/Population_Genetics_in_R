...
locus independently to make sure that one locus is not introducing bias into the
analysis.
...
should explore data analysis with and without this locus. Let's first see if
