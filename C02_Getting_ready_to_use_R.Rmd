...
The following package are utilized in this primer:
...
We wrote and actively maintain *poppr* `r citep(bib["kamvar2014poppr"])` and it is heavily relied upon in this primer. *Poppr* is an R package. You can think of a package as a library of functions written and curated by someone in the R user community, which you can loaded into R for use.
