...
- [Phytophthora rubi](https://github.com/grunwaldlab/Population_Genetics_in_R/blob/master/prubi_gbs.vcf.gz) GBS data
...
- [Phytophthora infestans](https://github.com/grunwaldlab/Population_Genetics_in_R/blob/master/pinfsc50_filtered.vcf.gz) Supercontig_1.50 genomic data    
