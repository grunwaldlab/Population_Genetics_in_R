...
Please make sure you have the most current version of R (3.4.1, [Single candle](http://i.onionstatic.com/avclub/5807/95/animated/original.gif)).
...
4. **Download the following datasets into a new folder called `APS_Workshop/`: **  
When you click on the below links our GitHub site should open in your web browser.
Click on the `Download` button and save each file to your local `APS_Workshop/` folder.

- [Phytophthora rubi](https://github.com/grunwaldlab/sandbox1/blob/master/prubi_gbs.vcf.gz) GBS data
- [Phytophthora rubi](https://files.osf.io/v1/resources/ytd6k/providers/osfstorage/593b001e594d90024142fb20?direct=true&action=download) population information data
- [Phytophthora infestans](https://github.com/grunwaldlab/sandbox1/blob/master/pinfsc50_filtered.vcf.gz) Supercontig_1.50 genomic data    


5. __Test that your system is ready:__    
...
```{r, eval=FALSE}
if(require(devtools)){
  source_gist("01a3d8efb21e0a4dbac0735270d147af", filename="apstest.R")       
} else {
...
The report file should look exactly like [this file](https://github.com/grunwaldlab/sandbox1/blob/master/apstest.txt).
If your results are different, and you don't understand why, send us an email with the report as an attachment.


6. **If you have never worked with R, please review the [Introduction to R](intro_to_R.html) page**
