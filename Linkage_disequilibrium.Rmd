...
Now $\bar{r}_d$ is located more centrally in the distribution expected from unlinked loci. Note that $P$ has improved and we fail to reject the null hypothesis of no linkage among markers. Thus it appears that populations in Mexico are partially sexual. 
