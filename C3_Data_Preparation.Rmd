...
The columns of the metadata beyond those three rows define the number of individuals contained within each population. Since this data is redundant with the second column, it is not necessary. Below is a modified version of the input format that should make it easier to format.
