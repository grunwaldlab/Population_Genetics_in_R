...
This is what normal GenAlEx data looks like. The first three rows are reserved
for metadata. Highlighted in blue are the important parts of the metadata that
is used by *poppr*:

| A | B | C |
|:----:|:----:|:----:|
| # of loci | # of individuals | # of populations |
