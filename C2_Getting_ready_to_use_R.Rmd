...
3. Download and install the **development version** of [poppr](http://github.com/grunwaldlab/poppr/tree/devel) and all its dependencies `r citep(bib["kamvar2014poppr"])` [INSTRUCTIONS HERE](https://github.com/grunwaldlab/poppr/tree/devel#stable-and-development-versions).
