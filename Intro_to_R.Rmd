...
and the [RStudio Desktop](http://www.rstudio.com/ide/) integrated development environment (IDE). We assume you installed the needed resources mentioned in chapter 2 on getting ready to use R.
