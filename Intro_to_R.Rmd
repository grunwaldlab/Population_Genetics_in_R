...
R studio has a very useful feature called code completion using the
...
This also work inside a function to find function arguments. Type `help(` and
hit <kbd>Tab</kbd> to select arguments for the help function.

R studio records your command history. Thus you can scroll up or down the
