...
`splitStrata` | Split a concatenated strata imported as a population
`strata` | Define a population strata of a genclone object
`strata` | Extract the strata data frame
...
`clonecorrect` | Clone censors at a specified population strata
