...
Clone correction is a method of masking repeated genotypes in your data as a way
of reducing bias. This technique is commonly use with the analysis of the index
of association as it will report more significant values with the presence of 
duplicated genotypes. Clone correction in *poppr* relies upon the knowledge of
the hierarchical levels in order to work. You should never clone correct your
data unless you know why and how you are clone correcting it.

Conceptually, you want to clone correct using your hierarchical levels based on
what you want to analyze and what the biology of the organism is. Using our data
above as an example, if we wanted to know the diversity of alleles within each
tree per year, how should we go about correcting for the clones? We use the 
function `clonecorrect` thusly:
...
We can see that the allelic diversity declines unless clone correction is implemented.
