...
underscore "\_" to separate each stratification.  This was already done for
...
After splitting the data populations are specified by stratification: "Tree
Year Symptom".
...
specific stratification and also compare the results with uncorrected data.
