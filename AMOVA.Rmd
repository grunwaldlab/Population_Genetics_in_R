...
at the different hierarchical levels, populations or subpopulations: 

```{r}
table(gethierarchy(Aeut, ~Pop))  # Populations
table(gethierarchy(Aeut, ~Pop/Subpop, combine = FALSE))  # Subpopulations
```
