...
stringing together commands from right to left. Below, are two examples of how
code can be improved with *magrittr*. [More details about magrittr can be found
in this link.](http://cran.r-project.org/web/packages/magrittr/vignettes/magrittr.html)
