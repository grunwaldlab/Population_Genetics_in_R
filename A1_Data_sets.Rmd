...
This microsatellite data comes from a larger data set of popualtions of *Phytophthora infestans*`r citep(bib["goss2014irish"])`. It contains 86 individuals representing 72 multilocus genotypes that have been genotyped over 11 loci. They are grouped by continent and country. This data set is used to demonstrate clone correction and linkage disequilibrium.
